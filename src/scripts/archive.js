...
if (!(root instanceof HTMLElement)) {
  // Page structure missing — nothing to do.
  throw new Error('archive root not found');
}
...
function readState() {
  ...
  // Anchor implies time mode if mode not explicitly set.
...
window.addEventListener('hashchange', () => {
  // Anchor click within time TOC may change hash. Re-evaluate mode.
